          ...
          <div v-else class="flex gap-1 items-center">
            ...
            <div class="relative">
              ...
              <div v-if="currentMetricsTable" v-show="showMetricsTable" class="text-nowrap absolute right-0 max-h-[75vh] shadow-lg overflow-x-hidden z-10 text-black grid gap-x-1 rounded-b-sm">
                ...
                <div class="column bg-white p-2 grid grid-cols-[1fr_auto_auto]">
                  <template v-for="(val, metric) in (Object.values(currentMetricsTable.results_1)[0] ?? {})" :key="metric">
                ...
                <div class="column bg-white p-2 grid grid-cols-[1fr_auto_auto]">
                  <template v-for="(val, metric) in (Object.values(currentMetricsTable.results_N)[0] ?? {})" :key="metric">
                    <div class="text-right px-2 py-1">
                      {{ metric.split("@")[0] }}
                    </div>
                    <div class="px-2 py-1 border-x-[1px] border-x-gray-300">
